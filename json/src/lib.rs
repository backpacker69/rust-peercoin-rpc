...
#![crate_name = "peercoin_rpc_json"]
#![crate_type = "rlib"]

pub extern crate peercoin;
#[allow(unused)]
...
use peercoin::address::NetworkUnchecked;
use peercoin::block::Version;
use peercoin::consensus::encode;
use peercoin::hashes::hex::FromHex;
use peercoin::hashes::sha256;
use peercoin::{
...
pub struct GetNetworkInfoResult {
    ...
    #[serde(rename = "relayfee", with = "peercoin::amount::serde::as_btc")]
    pub relay_fee: Amount,
    #[serde(rename = "incrementalfee", with = "peercoin::amount::serde::as_btc")]
...
pub struct GetWalletInfoResult {
    ...
    #[serde(rename = "paytxfee", with = "peercoin::amount::serde::as_btc")]
    pub pay_tx_fee: Amount,
    #[serde(rename = "hdseedid")]
    pub hd_seed_id: Option<peercoin::hash_types::XpubIdentifier>,
...
pub struct GetBlockResult {
    ...
    pub merkleroot: peercoin::hash_types::TxMerkleNode,
    pub tx: Vec<peercoin::Txid>,
    pub time: usize,
    ...
    pub n_tx: usize,
    pub previousblockhash: Option<peercoin::BlockHash>,
    pub nextblockhash: Option<peercoin::BlockHash>,
}
...
pub struct GetBlockHeaderResult {
    ...
    pub merkle_root: peercoin::hash_types::TxMerkleNode,
    pub time: usize,
    ...
    pub previous_block_hash: Option<peercoin::BlockHash>,
    #[serde(rename = "nextblockhash")]
    pub next_block_hash: Option<peercoin::BlockHash>,
}

#[derive(Clone, PartialEq, Debug, Deserialize, Serialize)]
pub struct GetBlockStatsResult {
    #[serde(rename = "avgfee", with = "peercoin::amount::serde::as_sat")]
    pub avg_fee: Amount,
    #[serde(rename = "avgfeerate", with = "peercoin::amount::serde::as_sat")]
    pub avg_fee_rate: Amount,
    #[serde(rename = "avgtxsize")]
    pub avg_tx_size: u32,
    #[serde(rename = "blockhash")]
    pub block_hash: peercoin::BlockHash,
    #[serde(rename = "feerate_percentiles")]
    pub fee_rate_percentiles: FeeRatePercentiles,
    pub height: u64,
    pub ins: usize,
    #[serde(rename = "maxfee", with = "peercoin::amount::serde::as_sat")]
    pub max_fee: Amount,
    #[serde(rename = "maxfeerate", with = "peercoin::amount::serde::as_sat")]
    pub max_fee_rate: Amount,
    #[serde(rename = "maxtxsize")]
    pub max_tx_size: u32,
    #[serde(rename = "medianfee", with = "peercoin::amount::serde::as_sat")]
    pub median_fee: Amount,
    #[serde(rename = "mediantime")]
    pub median_time: u64,
    #[serde(rename = "mediantxsize")]
    pub median_tx_size: u32,
    #[serde(rename = "minfee", with = "peercoin::amount::serde::as_sat")]
    pub min_fee: Amount,
    #[serde(rename = "minfeerate", with = "peercoin::amount::serde::as_sat")]
    pub min_fee_rate: Amount,
    #[serde(rename = "mintxsize")]
    pub min_tx_size: u32,
    pub outs: usize,
    #[serde(with = "peercoin::amount::serde::as_sat")]
    pub subsidy: Amount,
    ...
    #[serde(rename = "totalfee", with = "peercoin::amount::serde::as_sat")]
...
pub struct GetBlockStatsResultPartial {
    #[serde(
        default,
        rename = "avgfee",
        with = "peercoin::amount::serde::as_sat::opt",
    ...
    pub block_hash: Option<peercoin::BlockHash>,
...
pub struct GetRawTransactionResult {
    ...
    #[serde(with = "crate::serde_hex")]
    pub hex: Vec<u8>,
    pub txid: peercoin::Txid,
    pub hash: peercoin::Wtxid,
    pub size: usize,
    pub vsize: usize,
    pub version: u32,
    pub locktime: u32,
    ...
    pub blockhash: Option<peercoin::BlockHash>,
...
pub struct GetBlockFilterResult {
    pub header: peercoin::hash_types::FilterHash,
    #[serde(with = "crate::serde_hex")]
    pub filter: Vec<u8>,
}
...
pub struct GetTransactionResultDetail {
    ...
    pub vout: u32,
    #[serde(default, with = "peercoin::amount::serde::as_btc::opt")]
...
pub struct ListSinceBlockResult {
    ...
    pub lastblock: peercoin::BlockHash,
}

#[derive(Clone, PartialEq, Eq, Debug, Deserialize, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct GetTxOutResult {
    pub bestblock: peercoin::BlockHash,
...
pub struct ListUnspentQueryOptions {
    #[serde(
        ...
        with = "peercoin::amount::serde::as_btc::opt",
        skip_serializing_if = "Option::is_none"
    )]
...
pub struct GetBlockchainInfoResult {
    ...
    pub best_block_hash: peercoin::BlockHash,
...
pub struct GetMempoolInfoResult {
    ...
    #[serde(rename = "mempoolminfee", with = "peercoin::amount::serde::as_btc")]
    pub mempool_min_fee: Amount,
    /// Current minimum relay fee for transactions
    #[serde(rename = "minrelaytxfee", with = "peercoin::amount::serde::as_btc")]
    pub min_relay_tx_fee: Amount,
    /// Minimum fee rate increment for mempool limiting or replacement in BTC/kvB
    #[serde(rename = "incrementalrelayfee", with = "peercoin::amount::serde::as_btc")]
...
pub struct GetMempoolEntryResult {
    ...
    pub wtxid: peercoin::Txid,
    /// Fee information
    pub fees: GetMempoolEntryResultFees,
    /// Unconfirmed transactions used as inputs for this transaction
    pub depends: Vec<peercoin::Txid>,
...
pub struct GetPeerInfoResult {
    ...
    #[serde(rename = "minfeefilter", default, with = "peercoin::amount::serde::as_btc::opt")]
...
pub struct GetBlockTemplateResult {
    ...
    #[serde(rename = "previousblockhash")]
    pub previous_block_hash: peercoin::BlockHash,
    ...
    #[serde(default, with = "peercoin::script::ScriptBuf")]
    pub signet_challenge: peercoin::script::ScriptBuf,
    ...
    /// is activated.
    #[serde(with = "peercoin::script::ScriptBuf", default)]
    pub default_witness_commitment: peercoin::script::ScriptBuf,
    ...
    #[serde(rename = "coinbasevalue", with = "peercoin::amount::serde::as_sat", default)]
...
/// A wrapper around peercoin::EcdsaSighashType that will be serialized
/// according to what the RPC expects.
pub struct SigHashType(peercoin::sighash::EcdsaSighashType);

impl From<peercoin::sighash::EcdsaSighashType> for SigHashType {
    fn from(sht: peercoin::sighash::EcdsaSighashType) -> SigHashType {
        SigHashType(sht)
    }
}
...
impl serde::Serialize for SigHashType {
        ...
        S: serde::Serializer,
    {
        serializer.serialize_str(match self.0 {
            peercoin::sighash::EcdsaSighashType::All => "ALL",
            peercoin::sighash::EcdsaSighashType::None => "NONE",
            peercoin::sighash::EcdsaSighashType::Single => "SINGLE",
            peercoin::sighash::EcdsaSighashType::AllPlusAnyoneCanPay => "ALL|ANYONECANPAY",
            peercoin::sighash::EcdsaSighashType::NonePlusAnyoneCanPay => "NONE|ANYONECANPAY",
            peercoin::sighash::EcdsaSighashType::SinglePlusAnyoneCanPay => "SINGLE|ANYONECANPAY",
        })
    }
}
...
pub struct FundRawTransactionOptions {
    ...
    #[serde(with = "peercoin::amount::serde::as_btc::opt", skip_serializing_if = "Option::is_none")]
    pub fee_rate: Option<Amount>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct GetTxOutSetInfoResult {
    ...
    pub best_block: peercoin::BlockHash,
...
pub struct ScanTxOutResult {
    ...
    pub height: Option<u64>,
    #[serde(rename = "bestblock")]
    pub best_block_hash: Option<peercoin::BlockHash>,
    pub unspents: Vec<Utxo>,
    #[serde(with = "peercoin::amount::serde::as_btc")]
    pub total_amount: peercoin::Amount,
}
...
pub struct Utxo {
    pub txid: peercoin::Txid,
    pub vout: u32,
    pub script_pub_key: peercoin::ScriptBuf,
    #[serde(rename = "desc")]
    pub descriptor: String,
    #[serde(with = "peercoin::amount::serde::as_btc")]
    pub amount: peercoin::Amount,
    pub height: u64,
}
